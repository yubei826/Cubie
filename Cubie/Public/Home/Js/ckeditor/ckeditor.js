...
(function() {
    ...
    window.CKEDITOR || (window.CKEDITOR = function() {
        var a = {
            timestamp: +new Date(), //"DBAA", zawa: 防止config.js文件被缓存
            version: "4.3.1",
            revision: "3ecd0b8",
            ...
            domReady: function() {
                ...
                return function(d) {
                    ...
                    if (1 == a.length) if (document.addEventListener) document.addEventListener("DOMContentLoaded", b, !1),
    ...
    CKEDITOR.event.prototype = function() {
        ...
        b.prototype = {
            getListenerIndex: function(b) {
                for (var d = 0,
                a = this.listeners; d < a.length; d++) if (a[d].fn == b) return d;
                return - 1
            }
        };
        return {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(b) {
                ...
                for (var e = 1; e < a; e++) {
                    var n = arguments[e],
                    i;
                    for (i in n) if (d === true || b[i] == void 0) if (!h || i in h) b[i] = n[i]
                }
                return b
            },
            ...
            setTimeout: function(b, a, d, h, e) {
                ...
                return e.setTimeout(function() {
                    h ? b.apply(d, [].concat(h)) : b.apply(d)
                },
                a || 0)
            },
            trim: function() {
            ...
            indexOf: function(b, a) {
                if (typeof a == "function") for (var d = 0,
                h = b.length; d < h; d++) {
                    if (a(b[d])) return d
                } else {
            ...
            normalizeCssText: function(a, c) {
                var d = [],
                h,
                e = CKEDITOR.tools.parseCssText(a, true, c);
            ...
            enableHtml5Elements: function(a, c) {
                for (var d = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "mark", "meter", "nav", "output", "progress", "section", "summary", "time", "video"], h = d.length, e; h--;) {
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        a.setCustomData = function(a, c) {
            var d = this.getUniqueId(); (e[d] || (e[d] = {}))[a] = c;
            return this
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            mergeSiblings: function() {
                function a(b, d, c) {
                    if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(d)) {
                            for (var j = c ? b.getLast() : b.getFirst(); e.length;) e.shift().move(b, !c);
                            d.moveChildren(b, !c);
                            d.remove();
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++) if (e) for (var j = 0; j < e.length; j++) b.push([a, c[i], e[j]].join("-"));
            ...
            copyAttributes: function(a, b) {
                ...
                e = 0; e < c.length; e++) {
                    ...
                    o;
                    if (! (j in b)) if (j == "checked" && (o = this.getAttribute(j))) a.setAttribute(j, o);
    ...
    !0, {
        ...
        function a(a, b) {
            ...
            if (this.current) f = this.current[h](false, t, k);
                ...
                if (a) f.type == CKEDITOR.NODE_ELEMENT && (f = e > 0 ? f.getChild(e - 1) : k(f, true) === false ? null: f.getPreviousSourceNode(true, t, k));
                else {
                    f = d;
            ...
            for (c = t; c < m.length; c++) {
                ...
                if (!h[c] || j.$.parentNode != h[c].$.parentNode) for (j = j.getPrevious(); j;) {
                    ...
                    if (b == 2) g.$.insertBefore(j.$.cloneNode(true), g.$.firstChild);
                        ...
                        j.remove();
                        b == 1 && g.$.insertBefore(j.$, g.$.firstChild)
                    }
                    j = E
                }
                g && (g = n)
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            enlarge: function(a, b) {
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                ...
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    j = l.getText();
                                    if (/[^\s\ufeff]/.test(j)) l = null;
                                    else for (var g = l.$.getElementsByTagName("*"), n = 0, E; E = g[n++];) if (!CKEDITOR.dtd.$removeEmpty[E.nodeName.toLowerCase()]) {
                                        l = null;
                                        break
                                    }
                                    l && (r = !!j.length)
                    ...
                    for (; k || l;) {
                        ...
                        for (; l;) {
                            ...
                            if (l.type == CKEDITOR.NODE_TEXT) {
                                ...
                                if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark")) if (i && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                    j = l.getText();
                                    if (/[^\s\ufeff]/.test(j)) l = null;
                                    else {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    k = this.clone();
                    k.collapse();
                    k.setEndAt(e, CKEDITOR.POSITION_BEFORE_END);
                    k = new CKEDITOR.dom.walker(k);
            ...
            shrink: function(a, b, c) {
                if (!this.collapsed) {
                    ...
                    k = 1,
                    l = 1;
                    if (f && f.type == CKEDITOR.NODE_TEXT) if (h) if (h >= f.getLength()) d.setStartAfter(f);
                    else {
                        d.setStartBefore(f);
                        k = 0
                    } else d.setStartBefore(f);
                    if (e && e.type == CKEDITOR.NODE_TEXT) if (m) if (m >= e.getLength()) d.setEndAfter(e);
                    else {
                        d.setEndAfter(e);
                        l = 0
                    ...
                    d.guard = function(b, d) {
                        if (t(b)) return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(j) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable")) return false; ! d && b.type == CKEDITOR.NODE_ELEMENT && (j = b);
                        return true
                    };
                ...
                if (!this._.started) {
                    ...
                    if (!f.collapsed) {
                        ...
                        if (!this._.lastNode || !f.root.contains(this._.lastNode)) {
                            this._.lastNode = this._.docEndMarker = f.document.createText("");
                ...
                for (this._.nextNode = null; p;) {
                    ...
                    if (k) p.type == CKEDITOR.NODE_TEXT && d.test(p.getText()) && (k = 0);
                        ...
                        if (CKEDITOR.dtd.$block[t] && p.getAttribute("contenteditable") == "false") {
                            ...
                            if (t == "br") k = 1;
                            else if (!g && !p.getChildCount() && t != "hr") {
                                b = p;
                                q = p.equals(f);
                                break
                            }
    ...
    CKEDITOR.config = {
        ...
        function a(a, b, c, f, k) {
            ...
            if ((f || typeof a.elements != "function" || a.elements(m)) && (!a.match || a.match(b))) {
                ...
                if (!f) {
                    ...
                    if (!c.allStyles) c.allStyles = e(a.styles, b.styles, c.validStyles);
                    if (!c.allClasses) {
                        a = a.classes;
                        b = b.classes;
                        f = c.validClasses;
        ...
        function f(a, b, c) {
            var d = a.name;
            if (t.$empty[d] || !a.children.length) if (d == "hr" && b == "br") a.replaceWith(s());
            else {
                a.parent && c.push({
                    check: "it",
                    el: a.parent
                ...
                b: {
                    ...
                    m; e < k; ++e) {
                        m = d[e];
                        if (m.type == CKEDITOR.NODE_ELEMENT && !f[m.name]) {
                            f = false;
                            break b
                        }
                    }
                ...
                if (f) {
                    ...
                    l, k = d.length; k > 0;) {
                        ...
                        if (e && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && t.$inline[m.name])) {
                            ...
                            l = null;
                            m.insertAfter(a);
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (m.type == CKEDITOR.NODE_ELEMENT && !t[f.name][m.name]) && c.push({
                                check: "el-up",
                                el: m
                            })
                        }
        ...
        function y(a, b) {
            ...
            for (e in d) if (e == "class") {
                c = d[e].split(/\s+/);
                for (m = a.classes.join("|"); l = c.pop();) if (m.indexOf(l) == -1) return false
        ...
        CKEDITOR.filter = function(a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                if (b === true) this.disabled = true;
                    ...
                    this.allow(A[a.enterMode] + " " + A[a.shiftEnterMode], "default", 1)
                }
            } else {
            ...
            allow: function(a, c, d) {
                ...
                for (m = d.length; e < m; ++e) {
                    ...
                    if (l.elements === true || l.elements === null) {
                        ...
                        p = l.elements;
                        delete l.elements;
                        for (f in p) if (k[f]) k[f][h ? "unshift": "push"](l);
                        else k[f] = [l]
                    }
                }
                c.elements = k;
                ...
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a: {
                            ...
                            d.children.length == 1 && (f = d.children[0]).type == CKEDITOR.NODE_ELEMENT && h(f, m, l, c, b);
                            c = !c.length
                        }
                        c || k.push(a)
                    }
        ...
        Q = CKEDITOR.filter.transformationsTools = {
            ...
            lengthToAttribute: function(a, b, c) {
                ...
                if (! (c in a.attributes)) {
                    var d = a.styles[b],
                    f = d && d.match(/^(\d+)(?:\.\d*)?px$/);
                    f ? a.attributes[c] = f[1] : d == L && (a.attributes[c] = L)
                }
                delete a.styles[b]
            },
        ...
        return {
            load: function(b, c, d, h) {
                ...
                if (n === 0) o(true);
                    ...
                    var q = function(a, b) { (b ? i: j).push(a);
                        if (--n <= 0) {
    ...
    CKEDITOR.event.implementOn(CKEDITOR.ui); (function() {
        ...
        function d(a, b, c) {
            if (b) {
                ...
                for (e in l) {
                    d = l[e]; (c || d.contextSensitive) && d.refresh(a, b)
                }
            }
        }
        function h(a) {
            ...
            c = u[b] || (u[b] = {});
            if (c.fn) {
                c.fn.call(a, a.config); (CKEDITOR.getUrl(a.config.customConfig) == b || !h(a)) && a.fireOnce("customConfigLoaded")
        ...
        function o(a) {
            ...
            d = b.extraPlugins,
            e = b.removePlugins;
            if (d) var l = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"),
            c = c.replace(l, ""),
            c = c + ("," + d);
            ...
            function(c) {
                ...
                CKEDITOR.scriptLoader.load(k,
                function() {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++) for (var m = 0; m < d.length; m++) {
                        var l = d[m];
                ...
                g; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (g) g.push(c[0]);
                        ...
                        if (!/="/.test(d)) {
                            ...
                            this.onTagOpen(d, n, j); ! g && CKEDITOR.dtd.$cdata[d] && (g = [])
                        }
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function(d, h, g) {
            ...
            function o(b, c, d) {
                ...
                if (b.previous === void 0) {
                    ...
                    j(b); (!a(b) || b.children.length) && c.add(b);
                    b.name == "pre" && (l = false);
                ...
                if (a(f)) p.push(f);
                    ...
                    if (d == "br") y.push(f);
                        ...
                        for (;;) {
                            ...
                            if (!f.isUnknown && !m.isUnknown && !g[d]) if (m.isOptionalClose) u.onTagClose(h);
                            else if (d in b && h in b) {
                                h = m.children; (h = h[h.length - 1]) && h.name == "li" || o(h = new CKEDITOR.htmlParser.element("li"), m); ! f.returnPoint && (f.returnPoint = m);
                                m = h
                            } else if (d in CKEDITOR.dtd.$listItem && !s(d, h)) u.onTagOpen(d == "li" ? "ul": "dl", {},
                            0, 1);
                            else if (h in e && !s(d, h)) { ! f.returnPoint && (f.returnPoint = m);
                                m = m.parent
                            } else {
    ...
    "use strict"; (function() {
                ...
                return function(e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (l) for (m(l, 1) && k.push(l); l;) {
                            if (h(l) && (g = c(l)) && m(g)) if ((C = c(g)) && !h(C)) k.push(g);
                            else {
                                f(v).insertAfter(g);
                                g.remove()
                            }
                        ...
                        if (k = CKEDITOR.env.opera && !a || (typeof d == "function" ? d(e) !== false: d)) if (!v && !CKEDITOR.env.needsBrFiller && e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) k = false;
                ...
                return function(b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in e || "data-cke-eol" in e) delete e["data-cke-bogus"];
                            ...
                            var k = c(b); ! e && h(b.parent) ? g(b.parent, f(a)) : h(e) && (k && !h(k)) && f(a).insertBefore(e)
                        }
                    }
                }
            } (v);
        ...
        function p(a, b) {
            for (var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore = {
                id: 1
            }), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g,
            function(a) {
                return "<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>"
            }), k = 0; k < d.length; k++) a = a.replace(d[k],
            function(a) {
                a = a.replace(f,
                function(a, b, d) {
                    return c[d]
            ...
            a = a.replace(f,
            function(a, b, d) {
                return "<\!--" + m + (b ? "{C}": "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\>"
            });
        ...
        CKEDITOR.htmlDataProcessor = function(b) {
            ...
            b.on("toHtml",
            function(a) {
                a.data.dataValue.filterChildren(k.dataFilter, true)
            },
            null, null, 10);
            b.on("toHtml",
            function(a) {
            ...
            b.on("toDataFormat",
            function(a) {
                a.data.dataValue.filterChildren(k.htmlFilter, true)
            },
            null, null, 10);
            b.on("toDataFormat",
            function(a) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function(a, b) {
                ...
                for (i in g) {
                    ...
                    j && ((n = a.onAttribute(b, e, j, n)) === false ? delete g[j] : g[j] = n)
                }
            ...
            getFirst: function(b) {
                ...
                for (var d = 0,
                e = this.children.length; d < e; ++d) if (b(this.children[d])) return this.children[d];
                return null
            },
            getHtml: function() {
            ...
            setHtml: function(a) {
                for (var a = this.children = CKEDITOR.htmlParser.fragment.fromHtml(a).children, b = 0, e = a.length; b < e; ++b) a[b].parent = this
            },
            getOuterHtml: function() {
                var a = new CKEDITOR.htmlParser.basicWriter;
                this.writeHtml(a);
            ...
            getFilterContext: function(a) {
                ...
                a || (a = {
                    off: false,
                    nonEditable: false
                }); ! a.off && this.attributes["data-cke-processor"] == "off" && b.push("off", true); ! a.nonEditable && this.attributes.contenteditable == "false" && b.push("nonEditable", true);
    ...
    CKEDITOR.replaceClass = "ckeditor"; (function() {
        function a(a, c, g, n) {
            ...
            function() {
                b(i);
                n == CKEDITOR.ELEMENT_MODE_REPLACE && (i.config.autoUpdateElement && a.$.form) && i._attachToForm();
    ...
    CKEDITOR.config.startupMode = "wysiwyg"; (function() {
        ...
        function d(a, b) {
            return function(c) {
                var e = CKEDITOR.dom.element.get(c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget); (!e || !b.equals(e) && !b.contains(e)) && a.call(this, c)
            }
        }
        function h(a) {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                attachListener: function(a, b, c, e, d, l) { ! this._.listeners && (this._.listeners = []);
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    var g, h;
                    if (l) for (; (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[d]);) if (g.getName() in CKEDITOR.dtd.span) b.splitElement(g);
                ...
                insertElementIntoSelection: function(a) {
                    ...
                    if (this.insertElementIntoRange(a, d)) {
                        ...
                        if (k) if ((k = a.getNext(function(a) {
                            ...
                            k = d.fixBlock(true, e == CKEDITOR.ENTER_DIV ? "div": "p");
                ...
                setup: function() {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        function(b) {
                            ...
                            if (c in k) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = h(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    e = 1
                                } else if (m.collapsed) if ((i = g.block) && (n = i[c ? "getPrevious": "getNext"](o)) && n.type == CKEDITOR.NODE_ELEMENT && n.is("table") && m[c ? "checkStartOfBlock": "checkEndOfBlock"]()) {
                                    a.fire("saveSnapshot");
                                    ...
                                    a.fire("saveSnapshot");
                                    m["moveToElementEdit" + (c ? "End": "Start")](n);
                                    m.checkStartOfBlock() && m.checkEndOfBlock() ? n.remove() : m.select();
                                    a.fire("saveSnapshot");
                                    e = 1
                        ...
                        CKEDITOR.env.ie && this.attachListener(this, "click", b); ! CKEDITOR.env.ie && !CKEDITOR.env.opera && this.attachListener(this, "mousedown",
                        function(b) {
            ...
            function(b) {
                if (!c.readOnly) {
                    ...
                    if (e && !e.isLocked) {
                        ...
                        c.fire("lockSnapshot");
                        a(b);
                        c.fire("unlockSnapshot"); ! e && c.resetDirty()
                    }
                }
            })
        });
        ...
        var s = function() {
            ...
            function b(c, e) {
                ...
                for (var i = g[i.getName()], r = 0, j = c.getChildren(), n = j.count(), o = -1, q = -1, x = 0, s = d.contains(g.$list); r < n; ++r) {
                    ...
                    if (a(d)) {
                        m = d.getName();
                        if (s && m in CKEDITOR.dtd.$list) h = h.concat(b(d, e));
                        else {
                            l = !!i[m];
            ...
            return function(h, j, o) {
                ...
                if (!x.checkReadOnly()) {
                    ...
                    w = q.createBookmark(); (v = w.startNode.getPrevious(c)) && a(v) && d(v) && s.push(v); (v = w.startNode.getNext(c)) && a(v) && d(v) && s.push(v);
                    ...
                    if (w) {
                        ...
                        for (l(H, F); w < H.length; w++) {
                            ...
                            if (B) s = w > 0;
                                ...
                                if (C.lastNotAllowed && w < H.length - 1) { (R = X ? v: R) && F.setEndAt(R, CKEDITOR.POSITION_AFTER_START);
                                    q = 0
                                }
                                F.collapse()
                            }
                    ...
                    if (!j.dontMoveCaret) {
                        for (G = a(J.startContainer) && J.startContainer.getChild(J.startOffset - 1); G && a(G) && !G.is(g.$empty);) {
                            if (G.isBlockBoundary()) J.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
                            else {
        ...
        u = function() {
            ...
            return function(e) {
                ...
                if (l.is("table")) {
                    ...
                    l.is("tr") && (l = b(l, l.getParent().is("thead") ? "th": "td", g)); (d = l.getBogus()) && d.remove();
        ...
        function e() {
            ...
            if (!o) {
                b.call(this);
                o = CKEDITOR.tools.setTimeout(b, 200, this)
            }
        }
        function b() {
            o = null;
        ...
        function n(a, b, c) {
            ...
            null, null, -100);
            if (CKEDITOR.env.ie) var d = a.getDocument().on("selectionchange",
            function(a) {
                a.cancel()
            },
            null, null, -100);
        ...
        function(b) {
            ...
            function() {
                ...
                o,
                n;
                CKEDITOR.env.gecko && k.attachListener(k, "focus",
                function(a) {
                    a.removeListener();
                    if (o !== 0) if ((a = d.getSelection().getNative()) && a.isCollapsed && a.anchorNode == k.$) {
                        a = d.createRange();
                ...
                null, null, -2);
                k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusIn": "focus",
                function() {
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.opera || i) {
                    ...
                    f ? k.attachListener(k, "beforedeactivate", q, null, null, -1) : k.attachListener(d, "selectionCheck", q, null, null, -1);
                    k.attachListener(k, CKEDITOR.env.webkit ? "DOMFocusOut": "blur",
                    function() {
                        d.lockSelection(n);
                        o = 1
                    },
                ...
                if (CKEDITOR.env.ie && !i) {
                    ...
                    if (b.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) g.on("mousedown",
                        function(a) {
                            function b(a) {
                                a = a.data.$;
                                if (e) {
                ...
                if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko: CKEDITOR.env.opera) {
                    ...
                    k.attachListener(b.getDocumentElement(), "mouseup",
                    function() {
                        w && e.call(d);
                        w = 0
                    })
                } else k.attachListener(CKEDITOR.env.ie ? k: b.getDocumentElement(), "mouseup", e, d);
                CKEDITOR.env.webkit && k.attachListener(b, "keydown",
                function(a) {
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            d = this.getNative();
            var g, h;
            if (d) if (d.getRangeAt) g = (h = d.rangeCount && d.getRangeAt(0)) && new CKEDITOR.dom.node(h.commonAncestorContainer);
            else {
                try {
                    h = d.createRange()
                } catch(j) {}
                g = h && CKEDITOR.dom.element.get(h.item && h.item(0) || h.parentElement())
            }
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function() {
                ...
                function() {
                    ...
                    var b = function(b, c) {
                        ...
                        f, g, h = b.duplicate(), l = 0, m = e.length - 1, j = -1, i, o; l <= m;) {
                            j = Math.floor((l + m) / 2);
                            f = e[j];
            ...
            selectRanges: function(a) {
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    a: {
                        var d, e;
                        if (a.length == 1 && !(e = a[0]).collapsed && (b = e.getEnclosedNode()) && b.type == CKEDITOR.NODE_ELEMENT) {
                            e = e.clone();
                    ...
                    if (b) this.fake(b);
                        ...
                        if (f) {
                            ...
                            o,
                            n = b.getEnclosedNode();
                            if (n && n.type == CKEDITOR.NODE_ELEMENT && n.getName() in y && (!n.is("a") || !n.getText())) try {
    ...
    CKEDITOR.STYLE_OBJECT = 3; (function() {
            ...
            if (b.collapsed) {
                ...
                for (n.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(o)) {
                        ...
                        if (p && i && CKEDITOR.dtd.$block[s]) for (var t = n,
                        x = c(t), z = void 0, A = x.length, I = 0, t = A && new CKEDITOR.dom.range(t.getDocument()); I < A; ++I) {
                            var z = x[I],
                        ...
                        if (x) if ((x = n.getParent()) && ((x.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(x))) {
                            if (!q && (!s || !CKEDITOR.dtd.$removeEmpty[s] || (n.getPosition(o) | M) == M)) {
                                q = b.clone();
                                q.setStartBefore(n)
                            }
                            s = n.type;
                    ...
                    if (j && q && !q.collapsed) {
                        for (var j = y(this, d), p = j.hasAttributes(), r = q.getCommonAncestor(), s = {},
                        x = {},
                        z = {},
                        A = {},
                        T, P, Z; j && r;) {
                            if (r.getName() == f) {
                                for (T in g.attributes) if (!A[T] && (Z = r.getAttribute(P))) j.getAttribute(T) == Z ? x[T] = 1 : A[T] = 1;
        ...
        function d(a) {
            var b = a.getEnclosedNode() || a.getCommonAncestor(false, true); (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && m(a, this)
        }
        function h(a) {
        ...
        function k(a, b) {
            for (var c in a) a[c] = a[c].replace(I,
            function(a, c) {
                return b[c]
            })
        }
                    ...
                    getNextRange: function(g) {
                        ...
                        if (n && a.length > 1) {
                            ...
                            if (g) for (var j = 0; a[e + j + 1];) {
                                for (var o = n.document,
                                g = 0,
                                i = o.getById(d[j].endNode), o = o.getById(d[j + 1].startNode);;) {
...
*/
        ...
        CKEDITOR.dialog = function(a, b) {
            ...
            function d(b) {
                if (m == CKEDITOR.dialog._.currentTop) {
                    ...
                    m._.tabBarMode ? (c = c ? t.call(m) : u.call(m), m.selectPage(c), m._.tabs[c][0].focus()) : e(c ? -1 : 1),
                    o = 1;
                    else if (c == CKEDITOR.ALT + 121 && !m._.tabBarMode && 1 < m.getPageCount()) m._.tabBarMode = !0,
                    m._.tabs[m._.currentTabId][0].focus(),
                    o = 1;
                    else if ((37 == c || 39 == c) && m._.tabBarMode) c = c == (d ? 39 : 37) ? t.call(m) : u.call(m),
                    m.selectPage(c),
                    m._.tabs[c][0].focus(),
                    o = 1;
            ...
            h = {},
            o,
            j; ("OS" == l && CKEDITOR.env.mac || "rtl" == l && "ltr" == k || "ltr" == l && "rtl" == k) && i.buttons.reverse();
            ...
            function() {
                c();
                if (a.config.dialog_startupFocusTab && 1 < m._.pageCount) m._.tabBarMode = !0,
                m._.tabs[m._.currentTabId][0].focus();
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function(a, b, c, e, d, g, f) {
                    if (! (4 > arguments.length)) {
                        ...
                        l.push(">", o, "</", i, ">");
                        c.push(l.join("")); (this._ || (this._ = {})).dialog = a;
    ...
    CKEDITOR.config.coreStyles_superscript = {
        ...
        function w(b) {
            function a() {
                ...
                CKEDITOR.env.ie && (e.on("contextmenu", h, null, null, 0), e.on("beforepaste",
                function(b) {
            ...
            function l(e) {
                ...
                d.on(e, i); (7 < CKEDITOR.env.version ? a.$: a.$.selection.createRange()).execCommand(e);
            ...
            function o() {
                if (CKEDITOR.env.ie) {
                    ...
                    a.lock();
                    if (b.editable().fire(q) && !l("paste")) return a.unlock(),
                    !1;
                    a.unlock()
                } else try {
            ...
            function p(a) {
                ...
                case CKEDITOR.CTRL + 86 : case CKEDITOR.SHIFT + 45 : a = b.editable();
                    f(); ! CKEDITOR.env.ie && a.fire("beforepaste"); (CKEDITOR.env.opera || CKEDITOR.env.gecko && 10900 > CKEDITOR.env.version) && a.fire("paste");
                    break;
            ...
            b.getClipboardData = function(a, d) {
                ...
                null, null, 1E3); ! 1 === o() && (b.removeListener("paste", c), k && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", i), b.on("dialogHide",
                function(a) {
                    a.removeListener();
        ...
        function y(b, a) {
            ...
            if ((CKEDITOR.env.gecko || CKEDITOR.env.opera) && b.enterMode != CKEDITOR.ENTER_BR) CKEDITOR.env.gecko && (a = a.replace(/^<br><br>$/, "<br>")),
            -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g,
            function(a) {
                return c(a.length / 4)
            }) + "</p>");
            return p(b, a)
    ...
    CKEDITOR.plugins.add("richcombo", {
        ...
        function g(a, b, g, h, j, n, l, o) {
            for (var p = a.config,
            k = new CKEDITOR.style(l), c = j.split(";"), j = [], f = {},
            d = 0; d < c.length; d++) {
                var e = c[d];
                if (e) {
                    var e = e.split("/"),
    ...
    CKEDITOR.tools.extend(CKEDITOR.config, {
        ...
        function E(c, k, e) {
            ...
            for (h = f + 1; h < j.length; h++) if (j[h].indent > j[h - 1].indent + 1) {
                ...
                for (f = j[h].indent; j[h] && j[h].indent >= f;) j[h].indent += g,
                h++;
                h--
            }
        ...
        function A(c, k, e, b) {
            for (var j, g; j = c[b ? "getLast": "getFirst"](F);)(g = j.getDirection(1)) !== k.getDirection(1) && j.setAttribute("dir", g),
            j.remove(),
            e ? j[b ? "insertBefore": "insertAfter"](e) : k.append(j, b)
        }
        function B(c) {
            var k; (k = function(e) {
        ...
        function y(c, k, e) {
            ...
            h ? (h = h.getBogus()) && h.remove() : f && (h = f.getPrevious(q)) && v(h) && h.remove(); (h = b.getLast()) && (h.type == CKEDITOR.NODE_ELEMENT && h.is("br")) && h.remove(); (h = k.startContainer.getChild(k.startOffset)) ? b.insertBefore(h) : k.startContainer.append(b);
            ...
            listToArray: function(c, k, e, b, j) {
                ...
                h = c.getChildCount(); g < h; g++) {
                    ...
                    if ("li" == f.$.nodeName.toLowerCase()) {
                        ...
                        i.type == CKEDITOR.NODE_ELEMENT && r[i.getName()] ? CKEDITOR.plugins.list.listToArray(i, k, e, b + 1, a.grandparent) : a.contents.push(i)
                    }
                }
                return e
            },
        ...
        x.prototype = {
            exec: function(c) {
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    var j = c.editable();
                    if (j.getFirst(q)) {
                        var g = 1 == b.length && b[0]; (k = g && g.getEnclosedNode()) && (k.is && this.type == k.getName()) && this.setState(CKEDITOR.TRISTATE_ON)
                    } else k.enterMode == CKEDITOR.ENTER_BR ? j.appendBogus() : b[0].fixBlock(1, k.enterMode == CKEDITOR.ENTER_P ? "p": "div"),
                    e.selectRanges(b)
                }
                for (var k = e.createBookmarks(!0), j = [], h = {},
    ...
    CKEDITOR.plugins.pagebreakCmd = {
        ...
        var g, h = {
            ...
            exec: function(a) {
                ...
                b = window.open(b, null, "toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=" + e + ",height=" + c + ",left=" + d); ! CKEDITOR.env.ie && !CKEDITOR.env.gecko && (b = b.document, b.open(), b.write(a.dataValue), b.close());
                return ! 0
            }
        };
        ...
        r = function() {
            ...
            g = function() {
                if (! ("undefined" != typeof d.instances[b.name] || null != d.instances[b.name])) {
                    ...
                    e.afterMarkupRemove.push(function(a) { (new CKEDITOR.dom.element(a, e.document)).mergeSiblings()
                    });
                    if (c = d.instances[b.name]) e.sLang = c.sLang,
                    e.option(c.option()),
                    e.paused = c.paused;
            ...
            function(a) {
                if (d.isScaytEnabled(b) && "wysiwyg" == b.mode && ("undo" == a.data.name || "redo" == a.data.name)) d.getScayt(b).setDisabled(!0),
                d.refresh_timeout && window.clearTimeout(d.refresh_timeout),
                d.refresh_timeout = window.setTimeout(function() {
            ...
            e[f] = CKEDITOR.tools.override(e[f],
            function(a) {
                return function(b) {
                    var c = this.contents,
                    g = b.contents,
            ...
            e.checkDirty = CKEDITOR.tools.override(e.checkDirty,
            function(a) {
                return function() {
                    var b = null,
                    c = d.getScayt(this);
            ...
            init: function(a) {
                ...
                a.contextMenu && a.addMenuItems && a.contextMenu.addListener(function(b, c) {
                    ...
                    if (!i || !i.length) {
                        ...
                        typeof s != "number" && (s = 5); ! s && (s = i.length);
                        for (var k = 0,
                        r = i.length; k < r; k = k + 1) {
        ...
        CKEDITOR.plugins.add("stylescombo", {
            ...
            init: function(c) {
                ...
                function(b) {
                    if (b = b.data.styles) {
                        for (var a, h, d = 0,
                        g = b.length; d < g; d++) if (a = b[d], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a))) a._name = h,
